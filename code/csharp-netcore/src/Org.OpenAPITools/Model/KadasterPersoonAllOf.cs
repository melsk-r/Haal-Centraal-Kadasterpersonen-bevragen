...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class KadasterPersoonAllOf :  IEquatable<KadasterPersoonAllOf>, IValidatableObject
    {
        ...
        public KadasterPersoonAllOf(string domein = default(string), bool indicatieNietToonbareDiakriet = default(bool), Waardelijst beschikkingsbevoegdheid = default(Waardelijst), Adres woonadres = default(Adres), Postadres postadres = default(Postadres), List<string> kadastraalOnroerendeZaakIdentificaties = default(List<string>))
        {
            this.Domein = domein;
