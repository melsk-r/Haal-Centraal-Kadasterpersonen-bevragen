...
namespace Org.OpenAPITools.Api
{
    ...
    public partial class KadasterNietNatuurlijkPersonenApi : IKadasterNietNatuurlijkPersonenApi
    {
        ...
        /// <param name="fields">Hiermee kun je de inhoud van de resource naar behoefte aanpassen door een door komma&#39;s gescheiden lijst van property namen op te geven. Bij opgave van niet-bestaande properties wordt een 400 Bad Request teruggegeven. Wanneer de fields parameter niet is opgegeven, worden alle properties met een waarde teruggegeven. Zie [functionele specificaties](https://github.com/VNG-Realisatie/Haal-Centraal-common/blob/v1.0.0/features/fields.feature) (optional)</param>
        /// <returns>Task of ApiResponse (KadasterNietNatuurlijkPersoonHalCollectie)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<KadasterNietNatuurlijkPersoonHalCollectie>> GetKadasterNietNatuurlijkPersonenAsyncWithHttpInfo (string q, string fields = default(string))
        {
            // verify the required parameter 'q' is set
            if (q == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'q' when calling KadasterNietNatuurlijkPersonenApi->GetKadasterNietNatuurlijkPersonen");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<KadasterNietNatuurlijkPersoonHalCollectie>("/kadasternietnatuurlijkpersonen", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="fields">Hiermee kun je de inhoud van de resource naar behoefte aanpassen door een door komma&#39;s gescheiden lijst van property namen op te geven. Bij opgave van niet-bestaande properties wordt een 400 Bad Request teruggegeven. Wanneer de fields parameter niet is opgegeven, worden alle properties met een waarde teruggegeven. Zie [functionele specificaties](https://github.com/VNG-Realisatie/Haal-Centraal-common/blob/v1.0.0/features/fields.feature) (optional)</param>
        /// <returns>Task of ApiResponse (KadasterNietNatuurlijkPersoonHal)</returns>
        public async System.Threading.Tasks.Task<Org.OpenAPITools.Client.ApiResponse<KadasterNietNatuurlijkPersoonHal>> GetKadasterNietNatuurlijkPersoonAsyncWithHttpInfo (string kadasternietnatuurlijkpersoonidentificatie, string fields = default(string))
        {
            // verify the required parameter 'kadasternietnatuurlijkpersoonidentificatie' is set
            if (kadasternietnatuurlijkpersoonidentificatie == null)
                throw new Org.OpenAPITools.Client.ApiException(400, "Missing required parameter 'kadasternietnatuurlijkpersoonidentificatie' when calling KadasterNietNatuurlijkPersonenApi->GetKadasterNietNatuurlijkPersoon");
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<KadasterNietNatuurlijkPersoonHal>("/kadasternietnatuurlijkpersonen/{kadasternietnatuurlijkpersoonidentificatie}", localVarRequestOptions, this.Configuration);
