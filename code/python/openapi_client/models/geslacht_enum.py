...
class GeslachtEnum(object):
    ...
    allowable_values = [MAN, VROUW, ONBEKEND]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GeslachtEnum - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GeslachtEnum):
            return False
